...
const RepleContent = (props) => {
    ...
    const SubmitHandler = (e) => {
        ...
        axios.post(`${process.env.REACT_APP_API_URL}/api/reple/edit`, body).then((response) => {
    ...
    const DeleteHandler = (e) => {
        ...
        if (window.confirm("정말로 삭제하기겠습니까?")) {
            ...
            axios.post(`${process.env.REACT_APP_API_URL}/api/reple/delete`, body).then((response) => {
                if (response.data.success) {
                    alert("댓글ㄹ이 삭제죔");
